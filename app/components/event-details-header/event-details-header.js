...
export const Foreground = ( { event, eventDetails, rsvp, height, animatedValue, handleRSVP } ) =>
    <Overlay animatedValue={animatedValue} height={height}>
        <Animated.View style={ [ styles.titleRow, { height }, scrollTransform( animatedValue, height ) ] } pointerEvents="box-none">
            ...
            <EventDetailsRsvpButton rsvp={ rsvp } eventDetails={ eventDetails } handleRSVP={ handleRSVP } />
        </Animated.View>
    </Overlay>
;
